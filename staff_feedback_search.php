 ...
 <nav class="sidenav" id="mySidenav">
    ...
    <div class="content">
        <div style="text-align: right; padding:10px;">
            ...
            <br><a href='staff_feedback.php'>Display All User Feedbacks</a>
            <h2 style="text-align: center; color: black;">Search Result: <?=$search?></h2>
        </div>
        ...
        <table id="staff_feedback">
            ...
            if ($search!="") {
                ...
                $sql = "SELECT feedback.*, users.userName 
                        FROM feedback
                        INNER JOIN users ON feedback.userID = users.userID WHERE date = '$search'";
