...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES["fileToUpload"]) && $_FILES["fileToUpload"]["name"] == "") {
        $sql = "INSERT INTO events (eventName, eventDesc, eventDateStart, eventTimeStart, eventDateEnd, eventTimeEnd, eventLocation, eventCategory, userID)
        VALUES ('$eventName', '$eventDesc', '$eventDateStart', '$eventTimeStart', '$eventDateEnd', '$eventTimeEnd', '$eventLocation', '$eventCategory', $userID)";
    ...
    //If there is an image
        ...
        // uploadOK=1 if there is an image to be uploaded, filename not exists, file size is ok, and format is ok
        if ($uploadOk) {
            $sql = "INSERT INTO events (eventName, eventDesc, eventDateStart, eventTimeStart, eventDateEnd, eventTimeEnd, eventLocation, eventCategory, eventPhoto, userID)
            VALUES (
                '$eventName',
                '$eventDesc',
                '$eventDateStart',
