    ...
    <nav class="sidenav" id="mySidenav">
		...
		<a href="user_event_page.php" class="active"><i class="fa fa-calendar sidenav-icon"></i> Library Event Management</a>
		...
		<a href="user_activity.php"><i class="fa fa-file-text sidenav-icon"></i> Activity History</b></a>
